...
export const es = {
  ...
  // Inscriptions, secrets and the archive that keeps them.
  lore_hint: 'presiona abajo para leer',
  secret_found: '¡SALA OCULTA!',
  menu_archive: 'ARCHIVO',
  archive_title: 'ARCHIVO',
  archive_progress: '{n}/{m} INSCRIPCIONES',
  archive_locked: 'SIN LEER',
  archive_empty: 'La cueva todavía no te dijo nada.',
  archive_back: 'VOLVER',
  archive_secrets: 'SALAS OCULTAS: {n}',
  ow_glyphs: 'inscripciones {n}/{m}',
  ...
  ow_back_touch: 'PAUSA para volver',
  ow_back_gp: 'botón {b} para volver',
  ow_back_kb: 'ESC para volver',
...
const en: Record<StrKey, string> = {
  ...
  lore_hint: 'press down to read',
  secret_found: 'HIDDEN ROOM!',
  menu_archive: 'ARCHIVE',
  archive_title: 'ARCHIVE',
  archive_progress: '{n}/{m} INSCRIPTIONS',
  archive_locked: 'UNREAD',
  archive_empty: 'The cave has told you nothing yet.',
  archive_back: 'BACK',
  archive_secrets: 'HIDDEN ROOMS: {n}',
  ow_glyphs: 'inscriptions {n}/{m}',
  ...
  ow_back_touch: 'PAUSE to go back',
  ow_back_gp: '{b} to go back',
  ow_back_kb: 'ESC to go back',
